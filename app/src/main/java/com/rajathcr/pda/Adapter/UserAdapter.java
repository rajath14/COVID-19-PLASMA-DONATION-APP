package com.rajathcr.pda.Adapter;
...
import com.rajathcr.pda.Model.User;
import com.rajathcr.pda.Email.JavaMailApi;
import com.rajathcr.pda.R;
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                reference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        String mSubject = "PLASMA DONATION";
                                        String mMessage = "Hello "+ nameOfTheReceiver+", "+nameOfSender+
                                                " would like Plasma donation from you. Here's his/her details:\n"
                                                +"Name: "+nameOfSender+ "\n"+
                                                "Phone Number: "+phone+ "\n"+
                                                "Email: " +email+"\n"+
                                                "Blood Group: "+blood+ "\n"+
                                                "Kindly Reach out to him/her. Thank you!\n"
                                                +"PLASMA DONATION APP - DONATE PLASMA, SAVE LIVES!";
